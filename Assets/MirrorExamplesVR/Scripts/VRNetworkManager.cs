...
public class VRNetworkManager : NetworkManager
{
    ...
    public UnityEvent<NetworkConnectionToClient> ServerAddedPlayer = new();
    public UnityEvent<NetworkConnectionToClient> ServerRemovedPlayer = new();
    ...
    public override void OnServerDisconnect(NetworkConnectionToClient conn)
    {
        ...
        ServerRemovedPlayer.Invoke(conn);
    }
    ...
    public UnityEvent<string> ClientConnectedToServer = new();
    public UnityEvent ClientDisconnectedToServer = new();
    ...
    public override void OnClientConnect()
    {
        ...
        ClientConnectedToServer.Invoke(networkAddress);
    }
    ...
    public override void OnClientDisconnect()
    {
        ...
        ClientDisconnectedToServer.Invoke();
    }
