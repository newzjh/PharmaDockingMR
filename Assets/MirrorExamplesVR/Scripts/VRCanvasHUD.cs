...
public class VRCanvasHUD : MonoBehaviour
{
    ...
    public Button buttonHost, buttonServer, buttonClient, buttonStop, buttonAuto, buttonStandalone;
    ...
    private void Start()
    {
        ...
        buttonStandalone.onClick.AddListener(ButtonStandalone);
    ...
    public IEnumerator Waiter()
    {
        ...
        if (discoveredServers == null || discoveredServers.Count <= 0)
        {
            ...
            discoveredServers.Clear();
            NetworkManager.isStandalone = false;
    ...
    public void ButtonStandalone()
    {
        SetupInfoText("Starting as standalone");
        discoveredServers.Clear();
        NetworkManager.isStandalone = true;
        //NetworkManager.singleton.onlineScene = SceneManager.GetActiveScene().name;
        NetworkManager.singleton.StartHost();
        networkDiscovery.AdvertiseServer();
    }
