...
namespace Mirror
{
    ...
    public static class NetworkReaderExtensions
    {
        ...
        public static NativeArray<T> ReadNativeArray<T>(this NetworkReader reader) where T: struct
        {
            var ret = reader.ReadArray<T>();
            return new NativeArray<T>(ret, Allocator.Persistent);
        }
